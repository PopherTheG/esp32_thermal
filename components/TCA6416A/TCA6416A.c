...
unsigned char TCA6416AInitI2CReg(TCA6416ARegs *Regs, uint8_t slave_addr)
{
    ...
    I2C_Write(2, slave_addr, TCA6416A_CONFIG_REG0, (unsigned char *)&Regs->Config, 0);
    I2C_Write(2, slave_addr, TCA6416A_OUTPUT_REG0, (unsigned char *)&Regs->Output, 0);
    I2C_Write(2, slave_addr, TCA6416A_POLARITY_REG0, (unsigned char *)&Regs->PolarityInversion, 0);
